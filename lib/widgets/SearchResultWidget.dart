...
class SearchResultWidget extends StatelessWidget {
  String searchText;
  String sortOption;
  SearchResultWidget(this.searchText, {super.key, required this.sortOption});
    ...
    return FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          final filteredProducts = snapshot.data!.docs.where((doc) {
            final productName = doc['productName'].toLowerCase();
            final categoryName = doc['categoryName'].toLowerCase();
            final brandName = doc['brandName'].toLowerCase();
            final searchLower = searchText.toLowerCase();
            return productName.contains(searchLower) ||
                categoryName.contains(searchLower) ||
                brandName.contains(searchLower);
          }).toList();
          if (sortOption == 'Lower Price') {
            filteredProducts.sort((a, b) =>
                double.parse(a['salePrice'].replaceAll(',', '')).compareTo(
                    double.parse(b['salePrice'].replaceAll(',', ''))));
          } else if (sortOption == 'Higher Price') {
            filteredProducts.sort((a, b) =>
                double.parse(b['salePrice'].replaceAll(',', '')).compareTo(
                    double.parse(a['salePrice'].replaceAll(',', ''))));
