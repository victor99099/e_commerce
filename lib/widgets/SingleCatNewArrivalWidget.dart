...
class SingleCategoryWidgetNewArrival extends StatefulWidget {
  ...
  @override
  State<SingleCategoryWidgetNewArrival> createState() =>
      _AllCategoriesWidgetState();
}

class _AllCategoriesWidgetState extends State<SingleCategoryWidgetNewArrival> {
                    ...
                    onNotification: (scrollNotification) {
                      if (scrollNotification is ScrollEndNotification) {
                        if (_gridController.position.atEdge) {
                          bool isTop = _gridController.position.pixels == 0;
                          if (!isTop) {
                            // Allow parent to scroll up when grid is at bottom
